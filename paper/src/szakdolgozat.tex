...
mindig tartozik valódi koordinátapár.
  ...
  \begin{figure}
    \centering \includegraphics[width=.9\textwidth, viewport=0pt 60pt 300pt
    160pt,clip]{img/built/sunmoonvertex_eps}
...
és szintén egy kis üres helyet kihagyunk. Majd úgyanígy járunk el a $2$-es és a
$3$-as indexekkel is. Teljesen hasonló helyezhetjük el a tömbbe amásodik
