...
van egy trapézlista, ami lefedi az eredeti alakzatot. A következő lépés a
grafikus meghajtó felkészítése, beállítása és a trapézokból készített
háromszögek adatinak feltöltése, hogy végül kirenderelhessük az alakzatot.

  \section{Rajzolás GLES2-vel}

Az OpenGL~ES~2.0-ás grafikus függvénykönyvtárt \aref{GLES2:API}. fejezetrészben
