...
\begin{itemize}
  ...
  beállítással kirajzolja, ha a paraméterként kapott elem fókuszban van,
...
végrehajtási sorrendet nem lehet megváltoztatni, de az egyes lépésekben futó
részek programozhatóak (lásd \az+\emph{\ref{fig:opengles_20_pipeline2}.
ábrát}).
