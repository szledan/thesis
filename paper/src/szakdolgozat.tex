...
Ha a kapott $\epsilon_{max}$ nem kellően kicsi, akkor a körcikk felbontásával
(pl. felezésével) csökkenthetjük az eltérések mértékét. A folyamatot egészen
addig újra elvégezhetjük, amíg minden körcikk-darabnál nem lesz kellően kicsi
...
A felső réteget, a \func{Gepard} osztályt \aref{sec:Háttér}. fejezetben
...
ugyanakkor a Path egyik -- külön is definiált -- primitív alakzataként
(\func{rect}) azért érdemes pár szót ejteni róla. Elsőre erre az egyszerű
alakzatra készült el a kirajzolás általános folyamata. Kezdve az API hívástól
(\func{fillRect}) a felső rétegben. Majd haladva a köztes rétegen át a konkrét
kirajzolásig GLES2-t használva. A téglalapot mint két egymáshoz illesztett
derékszögű háromszöget értelmezzük. A négy sarokpontra mint vertex-ekre
hívódnak meg
egy nagyon egyszerű \emph{vertex shader program} (a \inenglish{shader} helyett
használatos még az \emph{árnyaló} kifejezés, mi viszont a továbbiakban is
shader-ként hivatkozunk rá), majd egy
szintén egyszerű színkitöltő \emph{fragment shader program} a grafikai
eszközön. Az alakzat egyszerűsége miatt mind a \emph{vertex}, mind pedig a
\emph{fragment} programrészekhez tartozó shader kódok viszonylag egyszerűek.
Ezért könnyen felállítható a rajzolás folyamata. Amit később felhasználva,
egyszerűbb beilleszteni a komplexebb alakzatok megjelenítését adó hívásokat.
