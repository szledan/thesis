...
A már ismertetett struktúrákhoz mind tartozik egy függvény ami egy példányt add
a listához. Ezek a függvények bizonyos feltételeket megvizsgálva és a
szabványhoz igazodva alkalmaznak bizonyos egyszerűsítéseket. Az
\func{addMoveToElement} függvény például kihasználja azt a nyilvánvaló tényt,
hogy az egymásután következő \func{moveTo} hívások összevonhatók, és csak a
legutolsó hívás koordinátáját kell letárolni. Minden vonalhúzó struktúrára
alkalmazni kell például, hogy ha elsőként kerülne az üres listába, akkor a
végpontját meghatározó koordinátát használva egy alakzatkezdő
...
sokkal komolyabb beállításokat és egyszerűsítéseket hozhatunk. Nyilvánvaló,
hogy egy körciklusnál nagyobb körbejárási szög leegyszerűsíthető. Vagy egy
...
A visszavezetés azt kell eldöntse, hogy az előző elem végpontjából hogyan és
meddig kell vonalat húzni a lekerekítést adó körcikkhez, milyen szögtől milyen
szögig terjed a körcikk, és hogyan kell az elem végpontjába egyenes vonalat
húzni a körcikktől.
