...
al.: Computer Graphics: Principles and Practice (2Nd Ed.), Boston, 1990,
Addison-Wesley Longman, 209. és 431. p.} Egyszerű módszer, ezért nagy
vonalakban ismertetjük. Kifejezetten kiemelve azokat a tényezőket, amelyek a
dolgozat szempontjából fontosabbak.
...
\begin{itemize}[noitemsep]
  ...
  Szemők: i. m. 41--42. p.},
  \item az elsőrendű Bézier görbe egy \emph{egyenes}\footnote{Kurusa --
  Szemők: i. m. 43. p.\label{fn:Kurusa:43p}},
  \item a másodrendű Bézier görbe egy \emph{parabola} (\emph{\ref{beziers}.
  ábra b.} pontja)\textsuperscript{\ref{fn:Kurusa:43p}},
...
$n$-ed rendű görbére osztja\footnote{Kurusa --
  Szemők: i. m. 47. p.}. A két görbe kontrollpontjai pedig az eredeti görbe
...
görbékkel.\footnote{M. Goldapp: \emph{Approximation of circular arcs by
cubic polynomials}, North Holland, 1991, Elsevier, 227–238. p.} Azonban jól és
gyorsan közelíthető
harmadrendű Bézier görbékkel \cite[Goldapp]{Goldapp:1991:approximation}.
  ...
  \psfrag{P3}[b][B][0.8]{\bf{$\begin{bmatrix} \cos\alpha \\ \sin\alpha
    ...
    maximum $\epsilon$ eltérésben illeszkedő harmadrendű Bézier görbe
    (sima vonal).}
  \end{figure}
