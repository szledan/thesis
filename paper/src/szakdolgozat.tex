...
alakzatot. A körvonal esetében egy köztes lépést alkalmazunk. Egy alakzat
körvonala felfogható egy adott vastagságú vonalakból álló, bonyolultabb alakzat
kitöltésével. Magyarán, az eredeti alakzatunkból képezünk egy olyan újabb
path-t, aminek a kitöltése az eredeti alakzat körvonalát adja. Ezt az újabb
...
egy a vastagságot kipótoló \emph{téglalap} vagy egy abba illeszkedő félkör kell
legyen. Ezeknek a kiegészítő formáknak az irányultságát határozzák meg az adott
pontban ismert vektorok.

Két vonal csatlakozásakor is úgy kell eljárni, hogy a hézagokat töltsük fel a
