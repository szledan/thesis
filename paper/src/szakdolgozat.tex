...
Ghostscript Tiger.svg példán keresztül vizsgáljuk és mutatjuk be. Ennek a
...
lesznek kirajzolva az alpha textúrába.
  ...
  \begin{table}[!t]
    \captionof{table}{A G. Tiger.svg renderelésekor keletkezett
...
%           \put(-113,7){\line(-15,10){50}}
    ...
    G. Tiger.svg eredmények különbsége. Az ábrán jól látható,
...
Canvas 2D előírásban szereplő függvényeket is. Ezeknek a megvalósítása egy
